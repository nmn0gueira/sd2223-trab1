...
public class RestFeedsClient extends RestClient implements Feeds {
    ...
    private Result<List<Message>> clt_getMessages(String user, long time) {
        ...
        Response r = target.path(user).path(String.valueOf(time))
                .request()
                .accept(MediaType.APPLICATION_JSON)
                .get();
    ...
    @Override
    public Result<Void> propagateSub(String user, String userSub) {return super.reTry(() -> clt_propagateSub(user, userSub));}
